      ...
      <div className="flex flex-col md:flex-row items-center md:space-x-12">
        <div className="flex-1">
          ...
          <div className='mb-4 mt-8'>
              ...
              <a href="mailto:kishore.deva2020@gmail.com" className='hover:underline'>
                  kishore.deva2020@.com
              </a>
          </div>
          <div className='mb-4'>
          ...
          <div className='mb-4'>
              ...
              <span>47/25,Brindavan Street,West Mambalam,Chennai,TamilNadu,India</span>
          </div>
        </div>
